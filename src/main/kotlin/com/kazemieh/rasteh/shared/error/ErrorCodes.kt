...
object ErrorCodes {
    ...
    const val RASTEH_NOT_FOUND = "RASTEH_NOT_FOUND"
    const val LOCATION_NOT_FOUND = "LOCATION_NOT_FOUND"
    const val SHOP_NOT_FOUND = "SHOP_NOT_FOUND"
    const val SHOP_ACCESS_DENIED = "SHOP_ACCESS_DENIED"
    const val SHOP_ALREADY_EXISTS = "SHOP_ALREADY_EXISTS"
    const val INVALID_SHOP_STATUS_TRANSITION = "INVALID_SHOP_STATUS_TRANSITION"
    const val VENDOR_NOT_APPROVED = "VENDOR_NOT_APPROVED"
    ...
    const val OFFER_NOT_FOUND = "OFFER_NOT_FOUND"
    const val OFFER_ACCESS_DENIED = "OFFER_ACCESS_DENIED"
    const val SHOP_DOES_NOT_ACCEPT_OFFERS = "SHOP_DOES_NOT_ACCEPT_OFFERS"
    const val BOOKMARK_NOT_FOUND = "BOOKMARK_NOT_FOUND"

    // ===== Marketplace orders =====
    const val PRODUCT_NOT_PURCHASABLE = "PRODUCT_NOT_PURCHASABLE"
    const val ORDER_VENDOR_MISMATCH = "ORDER_VENDOR_MISMATCH"
    const val MARKETPLACE_ORDER_NOT_FOUND = "MARKETPLACE_ORDER_NOT_FOUND"
    const val MARKETPLACE_INSUFFICIENT_STOCK = "MARKETPLACE_INSUFFICIENT_STOCK"
