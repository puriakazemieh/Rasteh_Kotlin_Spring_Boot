...
import com.kazemieh.rasteh.order.api.dto.OrderTrackingResponse
import com.kazemieh.rasteh.order.api.mapper.OrderMapper
import com.kazemieh.rasteh.order.application.exception.*
        ...
        if (req.useWallet) {
            ...
            if (walletPaid > BigDecimal.ZERO) {
                walletService.addTransaction(
                    ...
                    type = com.kazemieh.rasteh.wallet.persistence.entity.TransactionType.PURCHASE,
