package com.kazemieh.rasteh.customer.address.application

import com.kazemieh.rasteh.customer.address.api.dto.CreateAddressRequest
import com.kazemieh.rasteh.customer.address.api.dto.UpdateAddressRequest
import com.kazemieh.rasteh.customer.address.api.mapper.AddressMapper
...
import com.kazemieh.rasteh.shared.error.AddressAccessDeniedException
import com.kazemieh.rasteh.shared.error.AddressNotFoundException
import com.kazemieh.rasteh.shared.error.InvalidAddressException
import com.kazemieh.rasteh.shared.error.NotFoundException
...
class AddressService(
    ...
    @Transactional
    fun create(userId: Long, req: CreateAddressRequest) : com.kazemieh.rasteh.customer.address.api.dto.AddressResponse {
    ...
    @Transactional
    fun update(userId: Long, addressId: Long, req: UpdateAddressRequest) : com.kazemieh.rasteh.customer.address.api.dto.AddressResponse {
    ...
    @Transactional
    fun setDefault(userId: Long, addressId: Long) : com.kazemieh.rasteh.customer.address.api.dto.AddressResponse {
        val a = findOwnedAddress(userId, addressId)
