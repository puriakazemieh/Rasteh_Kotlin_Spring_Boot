...
import com.kazemieh.rasteh.catalog.api.dto.AdminAddImageRequest
import com.kazemieh.rasteh.catalog.api.dto.AdminProductImageResponse
import com.kazemieh.rasteh.catalog.api.dto.AdminReorderImagesRequest
...
class AdminProductImageController(
    ...
    fun add(
        ...
        if (contentType == null || !contentType.startsWith("image/")) {
            throw com.kazemieh.rasteh.catalog.application.exception.BadRequestException(
